<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="floor2.aspx.cs" Inherits="ParkingGarageApp.floor2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btn51" runat="server" Text="201" Visible="False" OnClick="btn51_Click" />
            ...
            &nbsp;<asp:Button ID="btn55" runat="server" Text="205" Visible="False" />
            &nbsp;<asp:Button ID="btn56" runat="server" Text="206" Visible="False" />
            &nbsp;<asp:Button ID="btn57" runat="server" Text="207" Visible="False" />
            &nbsp;<asp:Button ID="btn58" runat="server" Text="208" Visible="False" />
            &nbsp;<asp:Button ID="btn59" runat="server" Text="209" Visible="False" />
        ...
        <asp:Button ID="btn61" runat="server" Text="211" Visible="False" />
            ...
            &nbsp;<asp:Button ID="btn65" runat="server" Text="215" Visible="False" />
            &nbsp;<asp:Button ID="btn66" runat="server" Text="216" Visible="False" />
            &nbsp;<asp:Button ID="btn67" runat="server" Text="217" Visible="False" />
            &nbsp;<asp:Button ID="btn68" runat="server" Text="218" Visible="False" />
            &nbsp;<asp:Button ID="btn69" runat="server" Text="219" Visible="False" />
        ...
        <asp:Button ID="btn71" runat="server" Text="221" Visible="False" />
            ...
            &nbsp;<asp:Button ID="btn75" runat="server" Text="225" Visible="False" />
            &nbsp;<asp:Button ID="btn76" runat="server" Text="226" Visible="False" />
            &nbsp;<asp:Button ID="btn77" runat="server" Text="227" Visible="False" />
            &nbsp;<asp:Button ID="btn78" runat="server" Text="228" Visible="False" />
            &nbsp;<asp:Button ID="btn79" runat="server" Text="229" Visible="False" />
        ...
        <asp:Button ID="btn81" runat="server" Text="231" Visible="False" />
            ...
            &nbsp;<asp:Button ID="btn85" runat="server" Text="235" Visible="False" />
            &nbsp;<asp:Button ID="btn86" runat="server" Text="236" Visible="False" />
            &nbsp;<asp:Button ID="btn87" runat="server" Text="237" Visible="False" />
            &nbsp;<asp:Button ID="btn88" runat="server" Text="238" Visible="False" />
            &nbsp;<asp:Button ID="btn89" runat="server" Text="239" Visible="False" />
        ...
        <asp:Button ID="btn91" runat="server" Text="241" Visible="False" />
            ...
            &nbsp;<asp:Button ID="btn95" runat="server" Text="245" Visible="False" />
            &nbsp;<asp:Button ID="btn96" runat="server" Text="246" Visible="False" />
            &nbsp;<asp:Button ID="btn97" runat="server" Text="247" Visible="False" />
            &nbsp;<asp:Button ID="btn98" runat="server" Text="248" Visible="False" />
